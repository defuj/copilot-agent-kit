...
```bash
npx copilot-agent-kit init    # Prompts for platform (OpenCode / Copilot / Both)
npx copilot-agent-kit init --platform opencode   # Skip prompt, install OpenCode
npx copilot-agent-kit init --platform copilot    # Skip prompt, install Copilot
npx copilot-agent-kit init --platform both       # Skip prompt, install both
```
...
Copilot Agent KIT also supports **GitHub Copilot custom agents**. Install with the same command — you'll be prompted to choose your platform.

```bash
npx copilot-agent-kit init
# or skip the prompt:
npx copilot-agent-kit init --platform copilot
npx copilot-agent-kit init --platform both
```
...
Copilot Agent KIT skills work with both OpenCode and Copilot. To install for Copilot:

```bash
# Personal skills (all projects)
gh skill install github/defuj/copilot-agent-kit coding-standards
